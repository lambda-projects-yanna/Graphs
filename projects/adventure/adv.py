...
print(len(roomGraph))
while len(consecMap) < len(roomGraph):
    prevRoom = player.currentRoom.id
    print('\n starting loop OVER \n')
            
    if prevRoom not in consecMap:
        exits = {}
        for way in player.currentRoom.getExits():
            exits[way] = "?"
        consecMap[prevRoom] = exits
    exits = consecMap[prevRoom]
    print(prevRoom, consecMap, '\n \n')

    
#     for way1 in dirs:
#         if way1 in exits and exits[way1] == "?":
#             player.travel(way1)
#             traversalPath.append(way1)
#             newRoom = player.currentRoom.id
#             exits[way1] = newRoom
            
#             if newRoom not in consecMap:
#                 newRoom_exits = {}

#                 for way2 in player.currentRoom.getExits():
#                     newRoom_exits[way2] = "?"
#                 newRoom_exits[oppDirs[way1]] = prevRoom
#                 consecMap[newRoom] = newRoom_exits

#             else:
#                 consecMap[newRoom][oppDirs[way1]] = prevRoom
#             stack.push(oppDirs[way1])
...
#         print('\n TRAVERSAL GRAPH:',traversalGraph, '\n')
    ...
    if 'n' in exits and exits['n'] == '?':
        ...
        if newRoom not in consecMap:
            ...
            for way in player.currentRoom.getExits():
                newRoom_exits[way] = "?"
            newRoom_exits['s'] = prevRoom
            consecMap[newRoom] = newRoom_exits

        else:
            consecMap[newRoom]["s"] = prevRoom
        stack.push('s')
        ...
        if newRoom not in consecMap:
            ...
            for way in player.currentRoom.getExits():
                newRoom_exits[way] = "?"
            newRoom_exits['w'] = prevRoom
            consecMap[newRoom] = newRoom_exits

        else:
            consecMap[newRoom]["w"] = prevRoom
        stack.push('w')
        ...
        if newRoom not in consecMap:
            ...
            for way in player.currentRoom.getExits():
                newRoom_exits[way] = "?"
            newRoom_exits['n'] = prevRoom
            consecMap[newRoom] = newRoom_exits

        else:
            consecMap[newRoom]["n"] = prevRoom
        stack.push('n')
        ...
        if newRoom not in consecMap:
            ...
            for way in player.currentRoom.getExits():
                newRoom_exits[way] = "?"
            newRoom_exits['e'] = prevRoom
            consecMap[newRoom] = newRoom_exits

        else:
            consecMap[newRoom]["e"] = prevRoom
        stack.push('e')
